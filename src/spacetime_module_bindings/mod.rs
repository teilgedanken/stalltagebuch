...
pub use upsert_egg_record_reducer::upsert_egg_record;
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            ...
            Reducer::SetQuailPhoto {
                quail_uuid,
                photo_uuid,
            } => __sats::bsatn::to_vec(&set_quail_photo_reducer::SetQuailPhotoArgs {
            ...
            Reducer::UpsertEggRecord { args } => {
                __sats::bsatn::to_vec(&upsert_egg_record_reducer::UpsertEggRecordArgs {
                    args: args.clone(),
                })
            }
            _ => unreachable!(),
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                ...
                "quails" => db_update
                    .quails
                    .append(quails_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.quail_events = cache
            ...
            .with_updates_by_pk(|row| &row.uuid);
        diff.quails = cache
            .apply_diff_to_table::<Quail>("quails", &self.quails)
            .with_updates_by_pk(|row| &row.uuid);
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Quail>("quails", &self.quails, event);
    }
}
